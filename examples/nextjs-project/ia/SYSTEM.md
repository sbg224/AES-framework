...
Le champ « Structure : issue d’AES vX.Y.Z » (voir §7) constitue uniquement une information de traçabilité. Il permet de comparer, si le développeur le souhaite, l’origine structurelle d’un document à l’état courant du framework — jamais une obligation de mise à jour.
